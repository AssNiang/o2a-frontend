...
export class DiscussionComponent implements OnInit {
  ...
  user1 =
  {
     name: "Marie",
     id: 2,
     profileImageUrl:"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSvR2EmeDnAttbXXbBr_HtCX1qjGmUoSlP1_Q&usqp=CAU"
  }
